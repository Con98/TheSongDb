        ...
        <div style="width: 50%; text-align: center;">
            <form class="form-horizontal" action="FrontController" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="firstName" placeholder="<%= new TextBundle("enterName").getText(lang)%>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="surName"><%= new TextBundle("surname").getText(lang)%>:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="surName" placeholder="<%= new TextBundle("enterSurname").getText(lang)%>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="userName"><%= new TextBundle("username").getText(lang)%>:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="userName" placeholder="<%= new TextBundle("enterUsername").getText(lang)%>" required>
                    </div>
                </div>
                <div class="form-group">
