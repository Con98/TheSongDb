...
public class StatusDaoTest {
    ...
    public void testSendStatus() {
        ...
        StatusDao instance = new StatusDao("TheSongDb", "jdbc/TheSongDb");
    ...
    public void testDisplayOwnStatuses() {
        ...
        int userLoggedIn = 2;
        StatusDao instance = new StatusDao("TheSongDb", "jdbc/TheSongDb");
        ArrayList<Status> expResult = new ArrayList<Status>();
        expResult.add(new Status(2, 2, "2018-03-15 01:05:12", "testing test"));
        ArrayList<Status> result = instance.displayOwnStatuses(userLoggedIn);
        assertEquals(expResult, result);
    }

    /**
     * Test of displayStatuses method, of class StatusDao.
     */
    @Test
    public void testDisplayStatuses() {
        System.out.println("displayStatuses");
        int userLoggedIn = 1;
        StatusDao instance = new StatusDao("TheSongDb", "jdbc/TheSongDb");
        ArrayList<Status> expResult = new ArrayList<Status>();
        expResult.add(new Status(2, 2, "2018-03-15 01:05:12", "testing test"));
        ArrayList<Status> result = instance.displayStatuses(userLoggedIn);
        assertEquals(expResult, result);
    }
